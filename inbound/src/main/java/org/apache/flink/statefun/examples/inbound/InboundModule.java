 ...
 */
package org.apache.flink.statefun.examples.inbound;
 ...
 */
public final class InboundModule implements StatefulFunctionModule {
  ...
  public void configure(Map<String, String> globalConfiguration, Binder binder) {
    ...
    binder.bindIngress(KafkaIO.getIngressSpec(Identifiers.INBOUND_IDENTIFIER, kafkaAddress, "inbound"));
    binder.bindIngressRouter(Identifiers.INBOUND_IDENTIFIER, (input, downstream) ->
        downstream.forward(Identifiers.MAPPER_TYPE, input.substring(0, 1), input)
    );
  }
}
